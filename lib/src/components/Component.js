...
var Component = (function () {
    ...
    Component.prototype.getElement = function () {
        ...
        var nullElement = { element: protractor_1.browser.element };
    ...
    Component.prototype.scrollIntoView = function () {
        ...
        return protractor_1.browser.executeScript(scrollIntoView, element.getWebElement());
    };
    Component.prototype.getText = function () {
        var _this = this;
        return this.getElement().getTagName().then(function (t) {
            var tagName = t.toLowerCase();
            if (tagName == "input" || tagName == "textarea") {
                return _this.getElement().getAttribute("value");
            }
            else {
                return _this.getElement().getText();
            }
        });
    };
    Component.prototype.selectOption = function (value) {
        ...
        selectList
            .all(protractor_1.By.css("option"))
            .then(function (options) {
            protractor_1.promise.fullyResolved(options.map(function (option) {
                option
                    .getText()
                    .then(function (t) {
                    if (value == t) {
    ...
    Component.prototype.isVisibleCheck = function (shouldBeVisible) {
        ...
        return function () {
            var self = _this;
            return protractor_1.browser.isElementPresent(self.getElement())
    ...
    Component.prototype.isVisible = function (timeout) {
        ...
        return protractor_1.browser.wait(this.isVisibleCheck(true), timeout);
    };
    Component.prototype.isNotVisible = function (timeout) {
        if (timeout === void 0) { timeout = 5000; }
        return protractor_1.browser.wait(this.isVisibleCheck(false), timeout);
    };
