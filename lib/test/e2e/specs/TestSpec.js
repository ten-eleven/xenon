...
var ChatForm = (function (_super) {
    ...
    __decorate([
        src_1.field(src_1.Input, { qa: "message" }), 
        __metadata('design:type', src_1.Input)
    ], ChatForm.prototype, "message");
    __decorate([
        src_1.field(src_1.Button, { css: "#sendMessage" }), 
        __metadata('design:type', src_1.Button)
    ], ChatForm.prototype, "sendAction");
    __decorate([
        src_1.field(src_1.Button, { css: "#missingAction" }), 
        __metadata('design:type', src_1.Button)
...
var UserForm = (function (_super) {
    ...
    __decorate([
        src_1.field(src_1.Input, { qa: "username" }), 
        __metadata('design:type', src_1.Input)
    ], UserForm.prototype, "username");
    __decorate([
        src_1.field(src_1.Button, { qa: "send-action" }), 
        __metadata('design:type', src_1.Button)
